...
CONTATOS=$(sqlite -separator ',' $SQDB "SELECT qrg, qra, datetime(qtr,'unixepoch'), obs, mode FROM contacts WHERE callsign = '$CALLSIGN' ORDER BY qtr DESC;" |
...
echo "<table border=1><TR><TD><B>QRG</B></TD><TD><B>QRA</B></TD><TD><B>QTR</B></td><TD><B>Notas</B></td><TD><B>Modo</B></td></tr>"
